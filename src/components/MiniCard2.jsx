...
const MiniCard2 = () =>{
  return (
    <div className="w-[400px] h-[220px] bg-white rounded-lg mt-4 ml-4 p-4 space-y-3 border border-gray-200">
      ...
      <div className="space-y-1 ">
        ...
        <p className="text-gray-400">Active customer base and distribution network</p>
      </div>
      <div className="flex justify-start items-center space-x-2">
        {lastitems2.map((item, index) => (
          <div key={index} className='w-[120px] h-[65px] bg-gray-300 rounded-lg p-2 border border-gray-200 inline-block'>
