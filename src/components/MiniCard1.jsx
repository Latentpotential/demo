...
const MiniCard1 = () => {
  return (
    <div className="w-[450px] h-[220px] dark:bg-blue-950/70 dark:text-white dark:border-white bg-white rounded-lg mt-4 ml-4 p-4 space-y-3 border border-gray-200">
      <div className="flex justify-between items-center">
        <div>
          <p className="text-md">Lead Network</p>
        </div>
        <div className="text-sm dark:bg-blue-950/70 dark:text-white dark:border-white rounded-full border border-gray-200 text-primary bg-secondary px-2 py-1">
          <p>&#43;12.5% from last month</p>
        </div>
      </div>
      <div className="space-y-1">
        <p className="text-4xl font-bold">70,824</p>
        <p className="text-gray-400 dark:text-white">Total network connections across all channels</p>
      </div>
