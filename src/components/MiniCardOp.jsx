const MiniCardOp = ({ data }) => {
  ...
  return (
    <div className="w-auto h-[220px] dark:bg-black/20 dark:text-white dark:border-gray-500 bg-white rounded-lg mt-4 mr-1 ml-4 p-4 space-y-3 border border-gray-200">
      ...
      <div className="flex justify-start items-center space-x-2">
        {fillData?.map((item, index) => (
          <div
            key={index}
            className="w-[100px] h-[65px] dark:bg-black/20 dark:text-white dark:border-gray-500 bg-gray-300 rounded-lg p-2 border border-gray-200 inline-block"
          >
